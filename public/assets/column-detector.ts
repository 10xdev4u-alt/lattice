 ...
 *
 * pdfjs-dist's getTextContent returns positioned text items in the
 * order they were drawn on the page. For two-column papers this
 * interleaves the bottom of the left column with the top of the
 * right column, which destroys the reading order. This module fixes
 * that by clustering items into columns and sorting within each.
 */
...
function clusterIntoColumns(
  ...
  // edge and the next cluster's left edge.
